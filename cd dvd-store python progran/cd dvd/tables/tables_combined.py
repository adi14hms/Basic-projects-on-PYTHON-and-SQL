...
conn.cursor().execute("CREATE DATABASE DVD1")
print("Database Successfully Created")
conn.cursor().execute("USE DVD1")
...
conn.cursor().execute('create table online(customer_name varchar(100),age int,mobile_number int,cd_or_dvd varchar(65),rating int)')
